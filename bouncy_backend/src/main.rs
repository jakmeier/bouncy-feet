...
async fn main() -> anyhow::Result<()> {
    ...
    let unauthenticated_app = Router::new()
        ...
        .route(
            ...
            get(api_endoints::combo::public_user_combos),
        )
        .route(
    ...
    let protected_app = Router::new()
        ...
        .route(
            "/clubs/{club_id}/playlist/{playlist_id}/edit",
            post(api_endoints::club::edit_playlist),
        )
        .route(
        ...
        .route(
            "/user/combos/{combo_id}",
            delete(api_endoints::combo::delete_combo),
        )
        .route(
