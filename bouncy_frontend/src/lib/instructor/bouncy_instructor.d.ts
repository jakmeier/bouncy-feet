...
export class Lesson {
  ...
  readonly name: string;
  readonly explanation: string;
  readonly explainerVideo: string;
  readonly frontVideo: string;
  readonly backVideo: string;
...
export interface InitOutput {
  ...
  readonly course_video: (a: number, b: number) => void;
  ...
  readonly lesson_explainerVideo: (a: number, b: number) => void;
  readonly lesson_frontVideo: (a: number, b: number) => void;
  readonly lesson_backVideo: (a: number, b: number) => void;
