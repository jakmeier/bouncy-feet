...
export function dancefilebuilder_addDance(a: number, b: number): void;
export function dancefilebuilder_build(a: number, b: number): void;
...
export function danceinfo_new(a: number, b: number, c: number, d: number): number;
...
export function loadStepString(a: number, b: number, c: number): void;
