...
fn test_listing_static_steps() {
    ...
    let expect = expect!["Back-and-Forth,Back-and-Forth,Criss-Cross,Criss-Cross,Diagonal Running Man,Diagonal Running Man,Double RM,Double RM,Gangsta Hop,Gangsta Hop,Gangsta RM,Happy Feet,Idle,Idle Side,Jump In,Jump wave,Kicking Reverse RM,Kicking Reverse RM,Knee Up,Open RM on Heels,Open RM on Heels,Open Running Man,Open Running Man,Pendulum,Pendulum,Point,RM on Heels,RM on Heels,Reverse RM,Reverse RM,Running Man,Running Man,Simple Heels,Simple Heels,T-Step,T-Step,V-Step,V-Step,Wave,X-Outing,Yeah!,step-back,v-step-back"];
